...
import com.lat.be.service.ProductService;
...
@ApiMessage("Tạo sản phẩm mới")
    ...
    public ResponseEntity<Product> update(
        ...
        existingProduct.setCategory(new com.lat.be.domain.Category());
        existingProduct.getCategory().setId(updateProductDTO.getCategoryId());
        
        existingProduct.setSupplier(new com.lat.be.domain.Supplier());
